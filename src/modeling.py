...
def main():
    ...
    if selected_model_family == "catboost":
        ...
        x_train_heart = np.load(Path("data/processed/x_train_transformed.npz"))
        x_train_heart = x_train_heart['x_train_transformed']
        y_train_heart = np.load(Path("data/processed/y_train.npz"))
        y_train_heart = y_train_heart['y_train']
